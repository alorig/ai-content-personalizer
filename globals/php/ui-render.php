...
/*==================================================
  ## UI RENDER FUNCTIONS
  Description: UI rendering functions for admin pages
==================================================*/

/**
 * Render Content Engine admin page UI
 */
function igny8_render_content_engine_admin_page($enabled_post_types, $content_engine_status) {
    ?>
